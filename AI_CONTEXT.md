...
- **QoL**: Waila, Waila Harvestability, JourneyMap, GraveStone Mod, Better Storage (GTNH Edition), GT6 Ore Helper, Better Questing (with Bear's Den configs), BearCore, Cooking for Blockheads, Chisel, Carpenter's Blocks, Mouse Tweaks, Inventory Tweaks, Controlling, AppleCore, NEI Addons.
